...
const defaultStates = {
    'offline': <State>{
        "on":true,"bri":5,"transition":7,"ps":-1,"pss":0,"pl":-1,"ccnf":{"min":1,"max":5,"time":12},"nl":{"on":false,"dur":60,"fade":true,"tbri":255},"udpn":{"send":false,"recv":true},"lor":0,"mainseg":0,"seg":[{"id":0,"start":0,"stop":29,"len":29,"grp":1,"spc":0,"on":true,"bri":255,"col":[[255,255,255],[128,128,255],[18,179,0]],"fx":17,"sx":48,"ix":193,"pal":21,"sel":true,"rev":false}]
    },
    'idle': <State>{
